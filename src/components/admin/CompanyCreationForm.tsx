...
import { Building, Eye, EyeOff, Lock, User, Phone } from 'lucide-react'; // Changed Mail to Phone
...
interface CompanyFormData {
  ...
  phone_number: string; // This is the required field
...
const CompanyCreationForm: React.FC<CompanyCreationFormProps> = ({ onSuccess, onCancel }) => {
  ...
  const [companyData, setCompanyData] = useState<CompanyFormData>({
    ...
    description: '',
    company_username: '',
    phone_number: '', // Initial state for phone_number
    company_password: '',
  ...
  const handleCompanySubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log('[CompanyForm] Submitting company data:', {
        ...
        phone_number: companyData.phone_number, // Changed from company_email
  ...
  return (
    <form onSubmit={handleCompanySubmit} className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        {/* Company Phone Number (REPLACED EMAIL) */}
        <div className="mt-4">
          <div className="flex items-center space-x-2">
          ...
          <input
            ...
            required
          />
          <p className="text-xs text-gray-500 mt-1">This number will be used for notifications and communication</p>
        </div>
      ...
      <div className="flex justify-end space-x-3 pt-4">
        ...
        <button
          ...
          disabled={
            ...
            !companyData.phone_number || // Changed from company_email
